"""
R4 simulation — Nettkalibrering konsistent med EMPS NTC.

Changes from R3:
- Reverted 6 northern branch lines to original BM values (matching EMPS NTC exactly)
- Kept NO1↔NO2 scaling (0.587 factor) and SE2↔SE3 scaling (0.611 factor)

See branch.csv for details.
"""
...
SQL_FILE = SCENARIO_DIR / 'results' / f'powergama_r4_{SIM_YEAR_START}_{SIM_YEAR_END}.sqlite'
...
if __name__ == '__main__':
    print('=' * 60)
    print('R4 CASE - Nettkalibrering konsistent med EMPS NTC')
    print('=' * 60)

    data = load_grid_data()
    res = run_simulation(data)

    print('\nR4 simulation complete.')
