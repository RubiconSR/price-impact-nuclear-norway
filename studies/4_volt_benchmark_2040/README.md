# Study 4 — 2040 Volt Benchmark and Nuclear vs Offshore Wind

PowerGAMA-replikasjon av Volt/BCG "Mer vind til havs"-rapporten (april 2026)
i 2040-systemet, med parallelle kjernekraft-scenarier for direkte
sammenligning med havvind.

Adresserer paperets begrensning #3 (uniform distribution som forenklet
antakelse) ved å sammenligne konsentrert NO2-plassering vs jevnt fordelt.
